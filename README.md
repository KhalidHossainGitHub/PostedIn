...
The public deployment **[postedin-v2.vercel.app](https://postedin-v2.vercel.app)** runs on **Vercel** with **per-IP rate limiting** (Upstash) on `/api/generate` so casual abuse does not burn unlimited model usage. Self-hosted runs still rely on **your** OpenAI key and whatever limits you set in your account.
